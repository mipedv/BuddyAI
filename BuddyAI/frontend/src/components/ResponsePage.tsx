      ...
      {showFullChapterModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm animate-fade-in">
          <div 
            ...
            className="relative bg-white rounded-lg shadow-xl w-full max-w-5xl h-[75vh] flex flex-col animate-scale-in textbook-page-shadow"
          >
            {/* Modal Header */}
                    ...
                    try {
                      ...
                      <>
                        <div className="textbook-content flex justify-center items-center h-full relative">
                          ...
                          <div className="relative">
                            <img 
                              src={chapterImages[currentPage - 1]} 
              ...
              {chapterContent ? (
                (() => {
                  try {
                    ...
                    const chapterData = JSON.parse(chapterContent);
                    const { images: chapterImages, currentPage, totalPages } = chapterData as { images: string[]; currentPage: number; totalPages: number };
