...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen font-sans">
      {/* Left Panel */}
      <div className="w-full md:w-1/2 flex flex-col justify-center px-10 md:px-20 bg-[#f5f4ef]
 relative">
        {/* CBSE Syllabus Badge - Positioned top-right */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="zayan@wadihuda.com"
      ...
      {/* Right Panel (Image) - NO COLOR OVERLAY */}
